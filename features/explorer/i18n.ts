...
export const messages = {
  el: {
    ...
    shrinkVariationsHint: "Διατηρεί ολόκληρη την κύρια γραμμή και την επιλεγμένη κίνηση ορατές",
  ...
  en: {
    ...
    shrinkVariationsHint: "Keeps the complete main line and the selected move visible",
