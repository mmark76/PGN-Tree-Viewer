...
export const messages = {
  el: {
    ...
    downloadJson: "Αρχείο ChessTree JSON",
    ...
    invalidTreeFile: "Το αρχείο ChessTree JSON δεν είναι έγκυρο ή δεν υποστηρίζεται.",
    treeImported: "Το δέντρο ChessTree εισήχθη επιτυχώς.",
  ...
  en: {
    ...
    downloadJson: "ChessTree JSON file",
    ...
    invalidTreeFile: "The ChessTree JSON file is invalid or unsupported.",
    treeImported: "The ChessTree file was imported successfully.",
