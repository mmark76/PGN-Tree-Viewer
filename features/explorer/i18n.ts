...
export const messages = {
  el: {
    ...
    pasteSan: "Paste SAN",
    pasteSanDescription: "Επικολλήστε κινήσεις SAN, ελέγξτε τις και επιλέξτε πού θα προστεθούν.",
    closeSan: "Κλείσιμο Paste SAN",
    sanMoves: "Κινήσεις SAN",
    ...
    invalidSanMove: "Μη έγκυρη κίνηση SAN στη θέση",
    emptySan: "Δεν βρέθηκαν κινήσεις SAN.",
  ...
  en: {
    ...
    pasteSan: "Paste SAN",
    pasteSanDescription: "Paste SAN moves, validate them, and choose where to add them.",
    closeSan: "Close Paste SAN",
    sanMoves: "SAN moves",
    ...
    invalidSanMove: "Invalid SAN move at position",
    emptySan: "No SAN moves were found.",
